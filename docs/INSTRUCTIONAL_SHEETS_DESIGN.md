...
_Full design specifications are maintained in this document._
...
4. **Add Column Explanations**
   ...
   function addColumnExplanation(
     ...
     // Explanation cell
     const explRange = sheet.getRange(
       row,
       colStart + 4,
       1,
       colEnd - colStart - 3
     ...
     // Border between rows
     sheet
       .getRange(row, colStart, 1, colEnd - colStart + 1)
       .setBorder(
         null,
         null,
         true,
...
function onOpen() {
  ...
  ui.createMenu("Sales Log Pro 2.0")
    ...
    .addItem(
      ...
      "recreateAllInstructionalSheets"
    )
    .addSeparator()
    // ... other menu items ...
    .addToUi();
...
_End of Instructional Sheets Design Document_
